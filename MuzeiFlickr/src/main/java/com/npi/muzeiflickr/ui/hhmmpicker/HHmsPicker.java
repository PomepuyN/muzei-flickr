...
public class HHmsPicker extends LinearLayout implements Button.OnClickListener, Button.OnLongClickListener {
    ...
    protected HHmsView mEnteredHms;
    ...
    /**
     * Instantiates an HHmsPicker object
     *
     * @param context the Context required for creation
     */
    public HHmsPicker(Context context) {
        this(context, null);
    }
     ...
     */
    public HHmsPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected int getLayoutId() {
        return R.layout.hhms_picker_view;
    }
    ...
    protected void onFinishInflate() {
        ...
        mEnteredHms = (HHmsView) findViewById(R.id.hms_text);
    ...
    protected void updateHms() {
        mEnteredHms.setTime(mInput[5], mInput[4], mInput[3], mInput[2], mInput[1], mInput[0]);
    }
